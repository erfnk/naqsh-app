...
export const BoardScalarFieldEnumSchema = z.enum(['id', 'title', 'slug', 'description', 'organizationId', 'createdById', 'visibility', 'createdAt', 'updatedAt'])

export type BoardScalarFieldEnum = z.infer<typeof BoardScalarFieldEnumSchema>;

// File: BoardFavoriteScalarFieldEnum.schema.ts

export const BoardFavoriteScalarFieldEnumSchema = z.enum(['id', 'boardId', 'userId', 'createdAt'])

export type BoardFavoriteScalarFieldEnum = z.infer<typeof BoardFavoriteScalarFieldEnumSchema>;

// File: BoardAccessScalarFieldEnum.schema.ts

export const BoardAccessScalarFieldEnumSchema = z.enum(['id', 'boardId', 'userId', 'lastAccessedAt'])

export type BoardAccessScalarFieldEnum = z.infer<typeof BoardAccessScalarFieldEnumSchema>;

// File: ColumnScalarFieldEnum.schema.ts

export const ColumnScalarFieldEnumSchema = z.enum(['id', 'boardId', 'title', 'position', 'createdAt', 'updatedAt'])

export type ColumnScalarFieldEnum = z.infer<typeof ColumnScalarFieldEnumSchema>;

// File: TaskScalarFieldEnum.schema.ts

export const TaskScalarFieldEnumSchema = z.enum(['id', 'columnId', 'boardId', 'title', 'description', 'priority', 'position', 'assigneeId', 'createdById', 'createdAt', 'updatedAt'])
...
export type BoardFavoriteType = z.infer<typeof BoardFavoriteSchema>;


// File: BoardAccess.schema.ts
...
export type BoardAccessType = z.infer<typeof BoardAccessSchema>;


// File: Column.schema.ts
