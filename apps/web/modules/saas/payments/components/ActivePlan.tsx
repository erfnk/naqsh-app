...
import { CheckmarkBadge03Icon, Tick02Icon } from "@hugeicons/core-free-icons";
			...
			<div className="rounded-lg border p-4">
				<div className="">
					<div className="flex items-center gap-2">
						<HugeiconsIcon icon={CheckmarkBadge03Icon} className="size-6 text-primary" strokeWidth={2} />
					...
					{!!activePlanData.features?.length && (
						<ul className="mt-2 grid list-none gap-2 text-sm">
							{activePlanData.features.map((feature, key) => (
								...
								>
									<HugeiconsIcon icon={Tick02Icon} className="mr-2 size-4 text-primary" strokeWidth={2} />
									<span>{feature}</span>
								</li>
							))}
						</ul>
